...
import de.hybris.platform.acceleratorservices.web.payment.validation.UrlSchemeValidator;
...
public class SilentOrderPostMockController
{
	...
	private final HostnameVerifier dummyHostnameVerifier = (arg0, arg1) -> true; //NOSONAR
	...
	protected void sendMerchantCallback(final String merchantCallbackUrl, final Map<String, String> params)
	{
		...
		try
		{
			...
			{
				final SSLContext ctx = javax.net.ssl.SSLContext.getInstance("SSL"); //NOSONAR
