...
<c:choose>
	<c:when test="${country == 'US'}">
		...
		<formElement:formInputBox idKey="address.postcode" labelKey="address.postcode" path="billTo_postalCode" inputCSS="text" mandatory="true" tabindex="${tabindex + 8}" maxlength="10" oninputdata="this.value=this.value.replace(/[^a-zA-Z0-9- ]/g,'');"/>
		<formElement:formInputBox idKey="address.phone" labelKey="address.phone" path="billTo_phoneNumber" inputCSS="text" mandatory="true" tabindex="${tabindex + 9}" maxlength="10" oninputdata="this.value=this.value.replace(/[^0-9]/g,'');"/>
	</c:when>
	<c:when test="${country == 'CA'}">
		...
		<formElement:formInputBox idKey="address.postcode" labelKey="address.postcode" path="billTo_postalCode" inputCSS="text" mandatory="true" tabindex="${tabindex + 8}" maxlength="10" />
		<formElement:formInputBox idKey="address.phone" labelKey="address.phone" path="billTo_phoneNumber" inputCSS="text" mandatory="true" tabindex="${tabindex + 9}" maxlength="10" oninputdata="this.value=this.value.replace(/[^0-9]/g,'');"/>		
	</c:when>
	<c:when test="${country == 'CN'}">
		<formElement:formInputBox idKey="address.postcode" labelKey="address.postcode" path="billTo_postalCode" inputCSS="text" mandatory="true" tabindex="${tabindex + 2}" maxlength="10"/>
	...
	<c:when test="${country == 'JP'}">
		...
		<formElement:formInputBox idKey="address.postcode" labelKey="address.postcodeJP" path="billTo_postalCode" inputCSS="text" mandatory="true" tabindex="${tabindex + 4}" maxlength="10"/>
	...
	<c:otherwise>
		...
		<formElement:formInputBox idKey="address.line2" labelKey="address.line2" path="billTo_street2" inputCSS="text" mandatory="false" tabindex="${tabindex + 5}"/>
		<formElement:formInputBox idKey="address.townCity" labelKey="address.townCity" path="billTo_city" inputCSS="text" mandatory="true" tabindex="${tabindex + 6}"/>
		<formElement:formInputBox idKey="address.postcode" labelKey="address.postcode" path="billTo_postalCode" inputCSS="text" mandatory="true" tabindex="${tabindex + 7}" maxlength="10"/>
		<formElement:formInputBox idKey="address.phone" labelKey="address.phone" path="billTo_phoneNumber" inputCSS="text" mandatory="true" tabindex="${tabindex + 9}" maxlength="10" oninputdata="this.value=this.value.replace(/[^0-9]/g,'');"/>	
	</c:otherwise>
</c:choose>
