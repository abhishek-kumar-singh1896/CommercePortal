	                               ...
	                               <ul class="col-md-4 col-lg-3">
	                                   <c:forEach items="${childLevel1.children}" var="childLevel2" begin="${i.index}" end="${i.index + component.wrapAfter - 1}">
	                                        <c:forEach items="${childLevel2.entries}" var="childlink" >
		                                        <cms:component component="${childlink.item}" evaluateRestriction="true" element="li" class=""/>
	                                        </c:forEach>
	                                   </c:forEach>
	                               </ul>
	                		   </div>
	    ...
	    <div class="container">
			<div class="row">
                ...
                <span class="down-arrow-icon">
                        <svg>
							<use xlink:href="/gallagherb2cstorefront/web/webroot/WEB-INF/_ui-src/responsive/themes/amB2CCA/img/gallaher-icons.svg#arrow-down" />
                        </svg>
                    </span>
					${noticeHeader}
