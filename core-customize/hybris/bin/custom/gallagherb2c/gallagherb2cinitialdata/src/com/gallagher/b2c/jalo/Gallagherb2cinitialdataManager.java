...
/**
 * This is the extension manager of the Gallagherb2cinitialdata extension.
 */
public class Gallagherb2cinitialdataManager extends GeneratedGallagherb2cinitialdataManager
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
	 */
	private static final Logger LOG = Logger.getLogger(Gallagherb2cinitialdataManager.class.getName());
	 ...
	 */
	public Gallagherb2cinitialdataManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Gallagherb2cinitialdataManager called.");
		}
	}
	 ...
	 */
	public static Gallagherb2cinitialdataManager getInstance()
	{
		return (Gallagherb2cinitialdataManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Gallagherb2cinitialdataConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Gallagherb2cinitialdataManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Gallagherb2cinitialdataManager called, current tenant: " + getTenant().getTenantID());
		}
	}
