 ...
 */
package com.gallagher.commerceorgaddon.jalo;
...
import com.gallagher.commerceorgaddon.constants.GallaghercommerceorgaddonConstants;



/**
 * This is the extension manager of the Gallaghercommerceorgaddon extension.
 */
public class GallaghercommerceorgaddonManager extends GeneratedGallaghercommerceorgaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(GallaghercommerceorgaddonManager.class.getName());
	 ...
	 */
	public static GallaghercommerceorgaddonManager getInstance()
	{
		return (GallaghercommerceorgaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				GallaghercommerceorgaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public GallaghercommerceorgaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of GallaghercommerceorgaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of GallaghercommerceorgaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of GallaghercommerceorgaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
