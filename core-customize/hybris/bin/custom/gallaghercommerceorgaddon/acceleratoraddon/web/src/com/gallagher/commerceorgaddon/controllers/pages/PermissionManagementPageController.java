...
import com.gallagher.commerceorgaddon.forms.B2BPermissionTypeSelectionForm;
...
public class PermissionManagementPageController extends MyCompanyPageController
{
	...
	@RequireHardLogIn
	public String managePermissions(@RequestParam(value = "page", defaultValue = "0")
	final int page, @RequestParam(value = "show", defaultValue = "Page")
	final AbstractSearchPageController.ShowMode showMode, @RequestParam(value = "sort", defaultValue = B2BPermissionModel.CODE)
	final String sortCode, final Model model) throws CMSItemNotFoundException
	{
		...
		return GallaghercommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManagePermissionsPage;
	}

	@RequestMapping(value = "/view", method = RequestMethod.GET)
	@RequireHardLogIn
	public String viewPermissionDetails(@RequestParam("permissionCode")
	final String permissionCode, final Model model) throws CMSItemNotFoundException
	{
		...
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return GallaghercommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManagePermissionsViewPage;
	}

	@Override
	@RequestMapping(value = "/edit", method = RequestMethod.GET)
	@RequireHardLogIn
	public String editPermission(@RequestParam("permissionCode")
	final String permissionCode, final Model model) throws CMSItemNotFoundException
	{
	...
	@RequireHardLogIn
	public String editPermission(@Valid
	...
	public String getSelectPermissionTypePage(final Model model) throws CMSItemNotFoundException
	{
		...
		model.addAttribute("breadcrumbs", breadcrumbs);
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return GallaghercommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManagePermissionTypeSelectPage;
	...
	@RequireHardLogIn
	public String addNewPermissionForm(@RequestParam("permissionType")
	final String permissionType, final Model model) throws CMSItemNotFoundException
	{
		...
		return GallaghercommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManagePermissionAddPage;
	}


	@RequestMapping(value = "/add", method = RequestMethod.POST)
	@RequireHardLogIn
	public String addNewPermission(@Valid
	final B2BPermissionTypeSelectionForm b2BPermissionTypeSelectionForm, final BindingResult bindingResult, final Model model)
	...
	public String getAddErrorPermissionPage(final Model model) throws CMSItemNotFoundException
	{
		...
		return GallaghercommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManagePermissionAddErrorPage;
	}

	@RequestMapping(value = "/add/save", method = RequestMethod.POST)
	@RequireHardLogIn
	public String saveNewPermissionDetails(@Valid
	final B2BPermissionForm b2BPermissionForm, final BindingResult bindingResult, final Model model,
			final RedirectAttributes redirectModel) throws CMSItemNotFoundException, ParseException
	{
	...
	@RequireHardLogIn
	public String enablePermission(@RequestParam("permissionCode")
	final String permissionCode, final Model model) throws CMSItemNotFoundException
	{
		try
		{
	...
	@RequireHardLogIn
	public String confirmDisablePermission(@RequestParam("permissionCode")
	final String permissionCode, final Model model) throws CMSItemNotFoundException
	{
		final ContentPageModel organizationManagementPage = getContentPageForLabelOrId(ORGANIZATION_MANAGEMENT_CMS_PAGE);
		storeCmsPageInModel(model, organizationManagementPage);
		...
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return GallaghercommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManagePermissionDisablePage;
	}

	@RequestMapping(value = "/disable", method = RequestMethod.POST)
	@RequireHardLogIn
	public String disablePermission(@RequestParam("permissionCode")
	final String permissionCode, final Model model) throws CMSItemNotFoundException
	{
		try
		{
