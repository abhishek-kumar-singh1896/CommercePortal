...
import com.gallagher.commerceorgaddon.forms.B2BUnitForm;
...
public class BusinessUnitManagementPageController extends MyCompanyPageController
{
	...
	public String manageUnits(final Model model) throws CMSItemNotFoundException
	{
		...
		return GallaghercommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUnitsPage;
	}

	@Override
	@RequestMapping(value = "/details", method = RequestMethod.GET)
	@RequireHardLogIn
	public String unitDetails(@RequestParam("unit")
	...
	@RequireHardLogIn
	public String addCostCenterToUnit(@RequestParam("unit")
	final String unit, final Model model, final HttpServletRequest request) throws CMSItemNotFoundException
	{
	...
	@RequireHardLogIn
	public String editCostCenterToUnit(@RequestParam("unit")
	final String unit, @RequestParam("costCenterCode")
	...
	public String editCostCenterToUnit(@RequestParam("unit")
	final String unit, @RequestParam("costCenterCode")
	final String costCenterCode, @Valid
	final B2BCostCenterForm b2BCostCenterForm, final BindingResult bindingResult, final Model model,
			final HttpServletRequest request, final RedirectAttributes redirectModel) throws CMSItemNotFoundException
	{
		final B2BUnitData unitData = b2bUnitFacade.getUnitForUid(unit);
	...
	@RequireHardLogIn
	public String disableUnitConfirmation(@RequestParam("unit")
	final String unit, final Model model) throws CMSItemNotFoundException
	{
		final ContentPageModel manageUnitsPage = getContentPageForLabelOrId(MANAGE_UNITS_CMS_PAGE);
		storeCmsPageInModel(model, manageUnitsPage);
		...
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return GallaghercommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUnitDisablePage;
	}

	@RequestMapping(value = "/disable", method = RequestMethod.POST)
	@RequireHardLogIn
	public String disableUnit(@RequestParam("unit")
	final String unit, final Model model) throws CMSItemNotFoundException
	{
		final ContentPageModel manageUnitsPage = getContentPageForLabelOrId(MANAGE_UNITS_CMS_PAGE);
		storeCmsPageInModel(model, manageUnitsPage);
	...
	@RequireHardLogIn
	public String enableUnit(@RequestParam("unit")
	final String unit, final Model model) throws CMSItemNotFoundException
	{
		final ContentPageModel manageUnitsPage = getContentPageForLabelOrId(MANAGE_UNITS_CMS_PAGE);
		storeCmsPageInModel(model, manageUnitsPage);
	...
	@RequireHardLogIn
	public String editUnit(@RequestParam("unit")
	final String unit, final Model model) throws CMSItemNotFoundException
	{
		final ContentPageModel manageUnitsPage = getContentPageForLabelOrId(MANAGE_UNITS_CMS_PAGE);
		storeCmsPageInModel(model, manageUnitsPage);
		...
		return GallaghercommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUnitEditPage;
	}
	...
	public String editUnit(@RequestParam("unit")
	final String unit, @Valid
	final B2BUnitForm unitForm, final BindingResult bindingResult, final Model model, final RedirectAttributes redirectModel)
			throws CMSItemNotFoundException
	{
		...
		{
			LOG.error(String.format("Failed to save unit. Possibly non-unique id (original id: [%s] new id: [%s]).", unit,
					unitData.getUid()), e);
			GlobalMessages.addErrorMessage(model, "form.global.error");
			bindingResult.rejectValue("uid", "form.b2bunit.notunique");
			return GallaghercommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUnitEditPage;
	...
	@RequireHardLogIn
	public String createUnit(@RequestParam("unit")
	final String unit, final Model model, final HttpServletRequest request) throws CMSItemNotFoundException
	{
		final ContentPageModel manageUnitsPage = getContentPageForLabelOrId(MANAGE_UNITS_CMS_PAGE);
		storeCmsPageInModel(model, manageUnitsPage);
		...
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		model.addAttribute("businessProcesses", getBusinessProcesses());
		return GallaghercommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUnitCreatePage;
	}

	@RequestMapping(value = "/create", method = RequestMethod.POST)
	@RequireHardLogIn
	public String createUnit(@Valid
	final B2BUnitForm unitForm, final BindingResult bindingResult, final Model model, final HttpServletRequest request,
	...
	@RequireHardLogIn
	public String viewCostCenterForUnit(@RequestParam("unit")
	final String unit, @RequestParam("costCenterCode")
	final String costCenterCode, final Model model, final HttpServletRequest request) throws CMSItemNotFoundException
	{
	...
	@RequireHardLogIn
	public String addAddress(@RequestParam("unit")
	final String unit, final Model model) throws CMSItemNotFoundException
	{
		...
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return GallaghercommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUnitAddAddressPage;
	}
	...
	@RequireHardLogIn
	public String removeAddress(@RequestParam("unit")
	final String unit, @RequestParam("addressId")
	final String addressId, final RedirectAttributes redirectModel) throws CMSItemNotFoundException
	{
		try
		{
	...
	{ RequestMethod.GET })
	@RequireHardLogIn
	public String editAddress(@RequestParam("unit")
	final String unit, @RequestParam("addressId")
	final String addressId, final Model model, final RedirectAttributes redirectModel) throws CMSItemNotFoundException
	{
