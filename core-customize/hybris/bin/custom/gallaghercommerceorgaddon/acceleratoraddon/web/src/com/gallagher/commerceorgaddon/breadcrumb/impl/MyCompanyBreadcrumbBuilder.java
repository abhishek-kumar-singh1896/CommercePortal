 ...
 */
package com.gallagher.commerceorgaddon.breadcrumb.impl;
...
public class MyCompanyBreadcrumbBuilder
{
	...
	public List<Breadcrumb> createManageUserDetailsBreadcrumb(final String uid)
	{
		...
		breadcrumbs
				.add(new Breadcrumb(String.format("/my-company/organization-management/manage-users/details?user=%s", urlEncode(uid)),
