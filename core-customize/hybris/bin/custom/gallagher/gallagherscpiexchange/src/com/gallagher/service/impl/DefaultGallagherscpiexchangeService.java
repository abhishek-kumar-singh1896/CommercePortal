...
public class DefaultGallagherscpiexchangeService implements GallagherscpiexchangeService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultGallagherscpiexchangeService.class);
	...
	{
		return DefaultGallagherscpiexchangeService.class.getResourceAsStream("/gallagherscpiexchange/sap-hybris-platform.png");
	}
