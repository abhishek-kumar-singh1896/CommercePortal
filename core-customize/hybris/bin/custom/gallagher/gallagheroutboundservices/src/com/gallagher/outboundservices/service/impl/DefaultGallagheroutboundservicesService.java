...
public class DefaultGallagheroutboundservicesService implements GallagheroutboundservicesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultGallagheroutboundservicesService.class);
