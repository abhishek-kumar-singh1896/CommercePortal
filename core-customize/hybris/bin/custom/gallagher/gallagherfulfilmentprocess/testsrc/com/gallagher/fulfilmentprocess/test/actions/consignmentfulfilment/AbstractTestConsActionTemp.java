 ...
 */
package com.gallagher.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, GallagherFulfilmentProcessConstants.PARENT_PROCESS);
