 ...
 */
package com.gallagher.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(GallagherFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(GallagherFulfilmentProcessConstants.PARENT_PROCESS);
