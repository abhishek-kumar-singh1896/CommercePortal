...
public class DefaultGallagherstorefrontService implements GallagherstorefrontService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultGallagherstorefrontService.class);
	...
	{
		return DefaultGallagherstorefrontService.class.getResourceAsStream("/gallagherstorefront/sap-hybris-platform.png");
	}
