 ...
 */
package com.gallagher.test.setup;
...
import com.gallagher.test.constants.GallagherTestConstants;
import com.gallagher.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = GallagherTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/gallaghertest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/gallaghertest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/gallaghertest/import/cstickets.impex");
			...
			importImpexFile(context, "/gallaghertest/import/csquotes.impex");
		}
	}
}
