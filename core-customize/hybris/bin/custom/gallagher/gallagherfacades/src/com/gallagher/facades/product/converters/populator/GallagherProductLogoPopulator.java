 ...
 */
public class GallagherProductLogoPopulator<SOURCE extends ProductModel, TARGET extends ProductData>
		extends AbstractProductImagePopulator<SOURCE, TARGET>
{
	...
	public void populate(final SOURCE productModel, final TARGET productData) throws ConversionException
	{
		...
		if (logos != null)
		{
			...
			addLogos(logos, ImageDataType.LOGO, imageList);
	...
	{
		final Collection<MediaModel> logos = (Collection<MediaModel>) getProductAttribute(productModel, ProductModel.LOGO);
		//this is else part
