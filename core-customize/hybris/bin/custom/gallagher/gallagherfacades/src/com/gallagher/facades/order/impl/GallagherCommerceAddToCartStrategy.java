 ...
 *
 */
public class GallagherCommerceAddToCartStrategy extends DefaultCommerceAddToCartStrategy
{
	@Override
	protected CommerceCartModification doAddToCart(final CommerceCartParameter parameter) throws CommerceCartModificationException
	{
		...
		if (isProductForCode(parameter).booleanValue())
		{
			...
			{
				if (null == productModel.getEurope1Prices() || productModel.getEurope1Prices().size() == 0)
				{
