...
/**
 * Facet display name provider to add prefix unit to the value
 *
 * @author gauravkamboj
 */
public class GallagherFacetUnitPrefixDisplayNameProvider implements FacetDisplayNameProvider, FacetValueDisplayNameProvider
{
