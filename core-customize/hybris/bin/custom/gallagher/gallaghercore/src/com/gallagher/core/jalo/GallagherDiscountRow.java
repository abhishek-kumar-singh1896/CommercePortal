...
public class GallagherDiscountRow extends DiscountRow
{
	...
	{
		return this.getCustomersGroup(this.getSession().getSessionContext());
	}
	 ...
	 * @return
	 */
	private String getCustomersGroup(final SessionContext sessionContext)
	{
	...
	protected void updateMatchValue()
	{
		this.setMatchValue(this.calculateMatchValue(this.getProduct(), this.getProductId(), this.getProductGroup(), this.getUser(),
				this.getUg(), this.getSalesArea(), this.getCustomersGroup()));
	}
