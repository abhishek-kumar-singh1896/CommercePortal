...
public abstract class AbstractUpdateProductActionJob implements AutomatedWorkflowTemplateJob{
   ...
   // @Autowired
    ...
    protected ProductModel getAttachedProduct(final WorkflowActionModel action)
    {
