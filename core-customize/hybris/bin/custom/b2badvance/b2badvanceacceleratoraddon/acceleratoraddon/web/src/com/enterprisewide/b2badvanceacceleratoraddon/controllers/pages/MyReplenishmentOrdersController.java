 ...
 */
package com.enterprisewide.b2badvanceacceleratoraddon.controllers.pages;
...
import com.enterprisewide.b2badvanceacceleratoraddon.forms.ReorderForm;
...
public class MyReplenishmentOrdersController extends AbstractSearchPageController
{
			...
			@RequestParam("productCode") final String productCode, final Model model)
	{
		...
		return B2badvanceacceleratoraddonControllerConstants.Views.Pages.Checkout.ReadOnlyExpandedOrderForm;
	}
}
