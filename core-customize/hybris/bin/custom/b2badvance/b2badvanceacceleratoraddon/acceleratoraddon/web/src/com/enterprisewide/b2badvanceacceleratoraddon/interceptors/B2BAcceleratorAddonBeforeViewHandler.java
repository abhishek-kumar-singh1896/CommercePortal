 ...
 */
package com.enterprisewide.b2badvanceacceleratoraddon.interceptors;
...
public class B2BAcceleratorAddonBeforeViewHandler implements BeforeViewHandler
{
			...
			throws Exception
	{
		...
		{
			modelAndView.setViewName(B2badvanceacceleratoraddonConstants.ADDON_PREFIX + viewMap.get(viewName).get(VIEW_NAME_MAP_KEY));
		}
	}
