...
<%@ taglib prefix="addonProduct" tagdir="/WEB-INF/tags/addons/b2badvanceacceleratoraddon/responsive/product" %>
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
<%@ taglib prefix="cms" uri="http://hybris.com/tld/cmstags" %>
<%@ taglib prefix="nav" tagdir="/WEB-INF/tags/addons/b2badvanceacceleratoraddon/responsive/nav" %>
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
<%@ taglib prefix="formElement" tagdir="/WEB-INF/tags/responsive/formElement" %>
<%@ taglib prefix="addonFormElement" tagdir="/WEB-INF/tags/addons/b2badvanceacceleratoraddon/responsive/formElement" %>
