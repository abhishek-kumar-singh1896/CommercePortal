 ...
 */
package com.enterprisewide.b2badvanceacceleratoraddon.jalo;
...
/**
 * This is the extension manager of the B2badvanceacceleratoraddon extension.
 */
public class B2badvanceacceleratoraddonManager extends GeneratedB2badvanceacceleratoraddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(B2badvanceacceleratoraddonManager.class.getName());
	 ...
	 */
	public static B2badvanceacceleratoraddonManager getInstance()
	{
		return (B2badvanceacceleratoraddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				B2badvanceacceleratoraddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public B2badvanceacceleratoraddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of B2badvanceacceleratoraddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of B2badvanceacceleratoraddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of B2badvanceacceleratoraddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
