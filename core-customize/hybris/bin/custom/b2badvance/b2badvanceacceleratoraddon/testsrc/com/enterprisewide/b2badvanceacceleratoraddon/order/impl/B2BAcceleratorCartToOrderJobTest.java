 ...
 */
package com.enterprisewide.b2badvanceacceleratoraddon.order.impl;


import de.hybris.bootstrap.annotations.IntegrationTest;
import com.enterprisewide.b2badvanceacceleratoraddon.base.ProcessAwareBaseTest;
...
public class B2BAcceleratorCartToOrderJobTest extends ProcessAwareBaseTest
{
	...
	public void beforeTest() throws Exception
	{
		...
		importCsv("/b2badvanceacceleratoraddon/test/testOrganizations.csv", "utf-8");
		importCsv("/b2badvanceacceleratoraddon/test/testB2BCommerceCart.csv", "utf-8");
	...
	public void testPerformCartToOrderJob() throws Exception
	{
		...
		waitForCronJobFinished(cartToOrderCronJob, 10000);
	...
	private boolean waitForCronJobFinished(final CronJobModel cronJob, final long maxWaitMilliSeconds)
	{
		final long waitUntilMaxTime = System.currentTimeMillis() + maxWaitMilliSeconds;
