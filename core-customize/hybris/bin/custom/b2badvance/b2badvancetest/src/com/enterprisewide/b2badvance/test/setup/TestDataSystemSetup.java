 ...
 */
package com.enterprisewide.b2badvance.test.setup;
...
import com.enterprisewide.b2badvance.test.constants.B2badvanceTestConstants;
import com.enterprisewide.b2badvance.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = B2badvanceTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/b2badvancetest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/b2badvancetest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/b2badvancetest/import/cstickets.impex");
			...
			importImpexFile(context, "/b2badvancetest/import/csquotes.impex");**/
		}
	}
}
