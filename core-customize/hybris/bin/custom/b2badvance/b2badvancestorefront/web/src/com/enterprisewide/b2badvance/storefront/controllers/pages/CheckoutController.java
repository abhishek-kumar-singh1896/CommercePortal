...
public class CheckoutController extends AbstractCheckoutController
{
	...
	protected boolean validateShoppingCart(final RedirectAttributes redirectModel)
	{
		try
		{
			// Validate the cart
			...
			if (baseSiteModel.getMinimumSpendThreshold() != null && getCartFacade().getSessionCart().getSubTotal().getValue()
					.doubleValue() < baseSiteModel.getMinimumSpendThreshold())
			{
