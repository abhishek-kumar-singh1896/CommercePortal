...
public class AccountPageController extends AbstractSearchPageController
{
	...
	@RequireHardLogIn
	public String billing(@RequestParam(value = "page", defaultValue = "0") final int page,
						  @RequestParam(value = "show", defaultValue = "Page") final ShowMode showMode,
						  @RequestParam(value = "salesApplication", required = false) final SalesApplication salesApplication,
						  @RequestParam(value = "sort", required = false) final String sortCode, final Model model) throws CMSItemNotFoundException
	{
		...
		final SearchPageData<OrderData> searchPageData = b2badvanceOrderDetailsFacade
				.getPagedOrderDetailsForStatuses(pageableData);
		populateModel(model, searchPageData, showMode);
	...
	@RequireHardLogIn
	public String paymentHistory(@RequestParam(value = "page", defaultValue = "0") final int page,
								 @RequestParam(value = "show", defaultValue = "Page") final ShowMode showMode,
								 @RequestParam(value = "salesApplication", required = false) final SalesApplication salesApplication,
								 @RequestParam(value = "sort", required = false) final String sortCode, final Model model) throws CMSItemNotFoundException
	{
