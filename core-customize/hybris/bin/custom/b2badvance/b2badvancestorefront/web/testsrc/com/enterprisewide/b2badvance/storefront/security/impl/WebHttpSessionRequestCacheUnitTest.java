...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/b2badvancestorefront/electronics/en",
						"https://electronics.local:9002/b2badvancestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/b2badvancestorefront/electronics/en",
						"https://electronics.local:9002/b2badvancestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/b2badvancestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/b2badvancestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/b2badvancestorefront/electronics/en",
						"https://electronics.local:9002/b2badvancestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/b2badvancestorefront",
						"https://electronics.local:9002/b2badvancestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/b2badvancestorefront",
						"https://electronics.local:9002/b2badvancestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/b2badvancestorefront/electronics/en",
						"https://electronics.local:9002/b2badvancestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
