 ...
 */
package com.enterprisewide.b2badvance.commercewebservices.v1.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import com.enterprisewide.b2badvance.commercewebservices.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "b2badvancecommercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "b2badvancecommercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "b2badvancecommercewebservices.oauth2.tokenUrl";

	private static final String DESC = "b2badvancecommercewebservices.v1.description";
	private static final String TITLE = "b2badvancecommercewebservices.v1.title";
	private static final String VERSION = "b2badvancecommercewebservices.v1.version";
