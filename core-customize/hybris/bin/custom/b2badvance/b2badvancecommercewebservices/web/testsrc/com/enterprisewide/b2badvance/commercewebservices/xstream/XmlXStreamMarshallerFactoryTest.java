 ...
 */
package com.enterprisewide.b2badvance.commercewebservices.xstream;
...
public class XmlXStreamMarshallerFactoryTest
{
	...
	private static final String SERVICE_BEAN_DEF = "" + "<beans xmlns=\"http://www.springframework.org/schema/beans\"\n"//
			...
			+ "       <bean\n"//
			+ "             id=\"onlyOneInstance\"\n"//
			+ "             class=\"com.enterprisewide.b2badvance.commercewebservices.xstream.XmlXStreamMarshallerFactory\">\n"//
			+ "       </bean>\n"//
			+ "</beans>";
