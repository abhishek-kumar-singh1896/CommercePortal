...
@IntegrationTest
public class DefaultPaymetricServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	private PaymetricService paymetricService;
	@Resource
	...
	{
		// given
		final String logoCode = "paymetricPlatformLogo";

		// when
		final String logoUrl = paymetricService.getHybrisLogoUrl(logoCode);
