 ...
 */
package de.hybris.platform.paymetric.jalo;
...
/**
 * This is the extension manager of the Paymetric extension.
 */
public class PaymetricManager extends GeneratedPaymetricManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(PaymetricManager.class);
	 ...
	 */
	public static PaymetricManager getInstance()
	{
		return (PaymetricManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(PaymetricConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PaymetricManager() // NOPMD 
	{
		LOG.debug("constructor of PaymetricManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of PaymetricManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of PaymetricManager called, current tenant: {}", getTenant().getTenantID());
	}
