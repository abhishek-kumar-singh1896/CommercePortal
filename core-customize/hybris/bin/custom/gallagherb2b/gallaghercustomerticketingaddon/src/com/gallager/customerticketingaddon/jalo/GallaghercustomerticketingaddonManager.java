 ...
 */
package com.gallager.customerticketingaddon.jalo;
...
/**
 * This is the extension manager of the Gallaghercustomerticketingaddon extension.
 */
public class GallaghercustomerticketingaddonManager extends GeneratedGallaghercustomerticketingaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(GallaghercustomerticketingaddonManager.class.getName());
	 ...
	 */
	public static GallaghercustomerticketingaddonManager getInstance()
	{
		return (GallaghercustomerticketingaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				GallaghercustomerticketingaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public GallaghercustomerticketingaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of GallaghercustomerticketingaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of GallaghercustomerticketingaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of GallaghercustomerticketingaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
