...
import com.gallagher.b2b.storefront.forms.RestoreTemplateForm;
import com.gallagher.b2b.storefront.forms.validation.CreateTemplateFormValidator;
...
public class QuickOrderTemplatePageController extends B2BAdvanceAbstractSearchPageController
{
	...
	@RequireHardLogIn
	public String orderTemplates(@RequestParam(value = "page", defaultValue = "0")
	...
	@RequireHardLogIn
	public String restoreTemplateForId(@PathVariable(value = "templateId")
	final String templateId, final Model model) throws CommerceSaveCartException
	{
	...
	public String postRestoreOrderTemplateForId(@PathVariable(value = "templateId")
	final String templateId, final RestoreTemplateForm form, final BindingResult bindingResult,
	...
	@RequireHardLogIn
	public @ResponseBody String deleteOrderTemplateForId(@PathVariable(value = "templateId")
	final String templateId) throws CommerceSaveCartException
	{
		try
		{
			final CommerceSaveCartParameterData parameters = new CommerceSaveCartParameterData();
	...
	@RequireHardLogIn
	public final Map<String, Object> createTemplate(@RequestBody
	final CreateTemplateForm form, final Model model, final BindingResult bindingResult) throws CommerceSaveCartException
	{
