...
public class B2badvanceProductComparisonController
{
	...
	public String getCompareResults(@RequestParam(value = "code", required = true)
	final String productCode, @RequestParam(value = "action", required = true)
	final String action, final HttpServletRequest request, final Model model)
	...
	private boolean checkProductExists(final String productCode)
	{
		try
		{
	...
	public Integer add(@RequestParam("code")
	final String productCode, final HttpServletRequest request, final Model model)
	{
		productComparisonFacade.add(productCode);
	...
	public Integer remove(@RequestParam("code")
	final String productCode, final HttpServletRequest request, final Model model)
	{
		productComparisonFacade.remove(productCode);
		return productComparisonFacade.size();
	...
	public String removetest(@RequestParam("code")
	final String productCode, final HttpServletRequest request, final Model model)
	{
		productComparisonFacade.remove(productCode);
