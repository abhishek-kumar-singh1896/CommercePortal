			...
			<div class="details">
				...
				<div>
					...
					<c:if test="${! entry.product.multidimensional}">
						<c:choose>
								<c:when
									test="${entry.basePrice.value ne entry.sellingPrice.value}">
									<span class="font-size12 bold strike-through"> <format:price
								...
								<c:otherwise>
									<span class="bold"> <format:price priceData="${entry.basePrice}"
