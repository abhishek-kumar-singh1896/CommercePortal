...
<c:choose>
	...
	<c:otherwise>
		...
		<script type="text/javascript" src="${commonResourcePath}/js/custom/acc.gallaghercustomerticketaddon.js"></script>
...
<%-- bootstrap --%>
		...
		<c:forEach items="${addOnJavaScriptPaths}" var="addOnJavaScript">
		 ...
		 <%-- product comparison --%>
         <script type="text/javascript" src="${commonResourcePath}/customJs/acc.productcomparison.js"></script>
		<script type="text/javascript" src="${commonResourcePath}/js/acc.compare.js"></script>
	     <script type="text/javascript" src="${commonResourcePath}/customJs/custom.js"></script>
	     
       <%-- bulk order --%>
       <script type="text/javascript" src="${commonResourcePath}/customJs/acc.bulkorder.js"></script>
       <script type="text/javascript" src="${commonResourcePath}/js/jquery.filedrop.js"></script>
       <script type="text/javascript" src="${commonResourcePath}/js/ajaxfileupload.js"></script>
