                    ...
                    <div class="row">
						<div class="col-xs-12 col-sm-7 col-md-7">
									...
									<select id="sortOptions${top ? '1' : '2'}" name="sort"
										...
										<c:forEach items="${searchPageData.sorts}" var="sort">
											<option value="${sort.code}"
												${sort.code==searchPageData.pagination.sortCode? 'selected="selected"' : ''}>
							...
							<c:if test="${showDateRangeFilter}">
								<div class="form-group inline"
									style='width: 189px; margin-left: 20px;'>
									<label class="control-label" for="from-datepicker">
										From</label> <input type="text" id="from-datepicker"
										value="09/01/2017">
								</div>
								<div class="form-group inline"
									style='width: 189px; padding: 0px;'>
									<label class="control-label" for="to-datepicker"> To</label> <input
										type="text" id="to-datepicker" value="09/30/2017">
								</div>
						...
						<div class="col-xs-12 col-sm-6 col-md-5 pagination-wrap">
                            <pagination:advancePageSelectionPagination searchUrl="${searchUrl}" searchPageData="${searchPageData}"
