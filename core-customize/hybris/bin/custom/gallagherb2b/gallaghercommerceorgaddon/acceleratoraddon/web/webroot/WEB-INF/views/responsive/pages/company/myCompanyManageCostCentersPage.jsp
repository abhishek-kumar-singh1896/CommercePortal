			...
			<div class="col-sm-12 col-md-8 right-nav-content">
				<div class="account-section-header">
					...
					<div class="account-section-header-add pull-right">
						<a href="${fn:escapeXml(addCostCenterDetailsUrl)}"
							class="button add"> <spring:theme
								code="text.company.costCenter.addNew" />
						</a>
					</div>
				</div>
					...
					<div class="account-overview-table">
						<table class="responsive-table">
							<tr class="responsive-table-head hidden-xs">
								...
								<th><spring:theme
										code="text.company.costCenter.currency.title" /></th>
							...
							<c:forEach items="${searchPageData.results}" var="costCenter">
								...
								<tr class="responsive-table-item">
									...
									<td class="responsive-table-cell"><a
										href="${fn:escapeXml(viewCostCenterDetailsUrl)}"
										class="responsive-table-link">
											${fn:escapeXml(costCenter.code)} </a></td>
									<td class="hidden-sm hidden-md hidden-lg"><spring:theme
											code="text.company.column.name.name" /></td>
									<td class="responsive-table-cell">
										${fn:escapeXml(costCenter.name)}</td>
									<td class="hidden-sm hidden-md hidden-lg"><spring:theme
											code="text.company.column.parentUnit.name" /></td>
									<td class="responsive-table-cell"><a
										href="${fn:escapeXml(viewUnitDetailsUrl)}"
										class="responsive-table-link">
											${fn:escapeXml(costCenter.unit.name)} </a></td>
									<td class="hidden-sm hidden-md hidden-lg"><spring:theme
											code="text.company.costCenter.currency.title" /></td>
									<td class="responsive-table-cell">
										${fn:escapeXml(costCenter.currency.isocode)}</td>
									<td class="hidden-sm hidden-md hidden-lg"><spring:theme
