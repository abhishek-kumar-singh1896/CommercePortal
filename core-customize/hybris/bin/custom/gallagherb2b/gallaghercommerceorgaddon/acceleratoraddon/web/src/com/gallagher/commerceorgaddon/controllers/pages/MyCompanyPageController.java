...
public class MyCompanyPageController extends AbstractSearchPageController
{
	...
	protected String unitDetails(final String unit, final Model model) throws CMSItemNotFoundException
	{
		...
		return GallaghercommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUnitDetailsPage;
	}
	...
	protected String addCostCenter(final Model model) throws CMSItemNotFoundException
	{
		...
		model.addAttribute("breadcrumbs", breadcrumbs);
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return GallaghercommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyCostCenterAddPage;
	}

	protected String saveCostCenter(@Valid
	...
	protected String viewCostCenterDetails(final String costCenterCode, final Model model) throws CMSItemNotFoundException
	{
		...
		model.addAttribute("breadcrumbs", breadcrumbs);
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return GallaghercommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyCostCenterViewPage;
	}
	...
	protected String createUser(final Model model) throws CMSItemNotFoundException
	{
		...
		model.addAttribute("breadcrumbs", breadcrumbs);
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return GallaghercommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUserAddEditFormPage;
	}
	...
	protected String manageUserDetail(final String user, final Model model) throws CMSItemNotFoundException
	{
		...
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return GallaghercommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUserDetailPage;
	}
	...
	public String editPermission(final String permissionCode, final Model model) throws CMSItemNotFoundException
	{
		...
		model.addAttribute("breadcrumbs", breadcrumbs);
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return GallaghercommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManagePermissionsEditPage;
	}
