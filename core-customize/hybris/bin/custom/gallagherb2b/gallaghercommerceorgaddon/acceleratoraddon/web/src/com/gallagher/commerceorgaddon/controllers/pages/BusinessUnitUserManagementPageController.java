...
public class BusinessUnitUserManagementPageController extends MyCompanyPageController
{
	...
	@RequireHardLogIn
	public String createCustomerOfUnit(@RequestParam("unit")
	...
	public String createCustomerOfUnit(@RequestParam("unit")
	final String unit, @RequestParam("role")
	final String role, @Valid
	final B2BCustomerForm b2bCustomerForm, final BindingResult bindingResult, final Model model, final HttpServletRequest request,
	...
	@RequireHardLogIn
	public String viewCustomerOfUnit(@RequestParam("unit")
	final String unit, @RequestParam("user")
	final String user, final Model model, final HttpServletRequest request) throws CMSItemNotFoundException
	{
		...
		final List<Breadcrumb> breadcrumbs = myCompanyBreadcrumbBuilder.createManageUnitsDetailsBreadcrumbs(unit);
		breadcrumbs.add(new Breadcrumb(
				String.format("/my-company/organization-management/manage-units/viewuser?unit=%s&user=%s", urlEncode(unit),
						urlEncode(user)),
				getMessageSource().getMessage("text.company.manage.units.viewcustomer.breadcrumb", new Object[]
				{ user }, "View Customer {0} ", getI18nService().getCurrentLocale()), null));
		model.addAttribute("breadcrumbs", breadcrumbs);
		model.addAttribute("saveUrl",
				String.format(request.getContextPath() + "/my-company/organization-management/manage-units/edit?unit=%s&user=%s",
	...
	@RequireHardLogIn
	public String getPagedApproversForUnit(@RequestParam(value = "page", defaultValue = "0")
	...
	final String unit, final Model model, final HttpServletRequest request) throws CMSItemNotFoundException
	{
		...
		model.addAttribute("cancelUrl", getCancelUrl(MANAGE_UNIT_DETAILS_URL, request.getContextPath(), unit));
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return GallaghercommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUnitApproverListPage;
	}

	@RequestMapping(value = "/customers", method = RequestMethod.GET)
	@RequireHardLogIn
	public String getPagedCustomersForUnit(@RequestParam(value = "page", defaultValue = "0")
	final int page, @RequestParam(value = "show", defaultValue = "Page")
	final AbstractSearchPageController.ShowMode showMode, @RequestParam(value = "sort", defaultValue = UserModel.NAME)
	final String sortCode, @RequestParam("unit")
	final String unit, @RequestParam("role")
	...
	@RequireHardLogIn
	public String getPagedAdministratorsForUnit(@RequestParam(value = "page", defaultValue = "0")
	final int page, @RequestParam(value = "show", defaultValue = "Page")
	final AbstractSearchPageController.ShowMode showMode, @RequestParam(value = "sort", defaultValue = UserModel.NAME)
	final String sortCode, @RequestParam("unit")
	final String unit, @RequestParam("role")
	...
	@RequireHardLogIn
	public String getPagedManagersForUnit(@RequestParam(value = "page", defaultValue = "0")
	final int page, @RequestParam(value = "show", defaultValue = "Page")
	final AbstractSearchPageController.ShowMode showMode, @RequestParam(value = "sort", defaultValue = UserModel.NAME)
	final String sortCode, @RequestParam("unit")
	final String unit, @RequestParam("role")
	...
	@RequireHardLogIn
	public B2BSelectionData selectApprover(@RequestParam("unit")
	final String unit, @RequestParam("user")
	...
	{ RequestMethod.GET, RequestMethod.POST })
	@RequireHardLogIn
	public B2BSelectionData deselectApprover(@RequestParam("unit")
	final String unit, @RequestParam("user")
	final String user) throws CMSItemNotFoundException
	{
	...
	{ RequestMethod.GET, RequestMethod.POST })
	@RequireHardLogIn
	public String removeApproverFromUnit(@RequestParam("unit")
	final String unit, @RequestParam("user")
	...
	{ RequestMethod.GET })
	@RequireHardLogIn
	public String confirmRemoveApproverFromUnit(@RequestParam("unit")
	final String unit, @RequestParam("user")
	final String user, @RequestParam("role")
	final String role, final Model model, final HttpServletRequest request) throws CMSItemNotFoundException
	{
		storeCmsPageInModel(model, getContentPageForLabelOrId(MY_COMPANY_CMS_PAGE));
		setUpMetaDataForContentPage(model, getContentPageForLabelOrId(MANAGE_UNITS_CMS_PAGE));
	...
	{ RequestMethod.GET, RequestMethod.POST })
	@RequireHardLogIn
	public String removeMemberFromUnit(@RequestParam("unit")
	final String unit, @RequestParam("user")
	final String user, @RequestParam("role")
	final String role, final RedirectAttributes redirectModel) throws CMSItemNotFoundException
	{
	...
	{ RequestMethod.GET })
	@RequireHardLogIn
	public String confirmRemoveMemberFromUnit(@RequestParam("unit")
	final String unit, @RequestParam("user")
	final String user, @RequestParam("role")
	final String role, final Model model, final HttpServletRequest request) throws CMSItemNotFoundException
	{
	...
	{ RequestMethod.GET, RequestMethod.POST })
	@RequireHardLogIn
	public B2BSelectionData selectCustomer(@RequestParam("user")
	final String user, @RequestParam("role")
	...
	{ RequestMethod.GET, RequestMethod.POST })
	@RequireHardLogIn
	public B2BSelectionData deselectCustomer(@RequestParam("user")
	final String user, @RequestParam("role")
	final String role) throws CMSItemNotFoundException
	{
