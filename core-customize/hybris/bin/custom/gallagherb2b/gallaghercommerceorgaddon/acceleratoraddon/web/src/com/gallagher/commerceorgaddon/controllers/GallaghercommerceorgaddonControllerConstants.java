 ...
 */
package com.gallagher.commerceorgaddon.controllers;

import com.gallagher.commerceorgaddon.constants.GallaghercommerceorgaddonConstants;

/**
 */
public interface GallaghercommerceorgaddonControllerConstants
{
	...
	interface Views
	{
		interface Pages
		{
			...
			interface MyCompany
			{
				...
				String VIEW_PAGE_PREFIX = ADD_ON_PREFIX + "/" + GallaghercommerceorgaddonConstants.EXTENSIONNAME + "/";
				...
				String MyCompanyManageUsergroupDisableConfirmationPage = VIEW_PAGE_PREFIX
						+ "pages/company/myCompanyManageUsergroupDisableConfirmationPage";
				...
				String MyCompanyManagePermissionTypeSelectPage = VIEW_PAGE_PREFIX
						+ "pages/company/myCompanyManagePermissionTypeSelectPage";
				String MyCompanyManagePermissionAddPage = VIEW_PAGE_PREFIX + "pages/company/myCompanyManagePermissionAddPage";
				String MyCompanyManagePermissionAddErrorPage = VIEW_PAGE_PREFIX
						+ "pages/company/myCompanyManagePermissionAddErrorPage";
				String MyCompanyManageUserCustomersPage = VIEW_PAGE_PREFIX + "pages/company/myCompanyManageUserCustomersPage";
				String MyCompanyManageUserGroupPermissionsPage = VIEW_PAGE_PREFIX
						+ "pages/company/myCompanyManageUserGroupPermissionsPage";
				...
				String MyCompanyManageUsergroupRemoveConfirmationPage = VIEW_PAGE_PREFIX
						+ "pages/company/myCompanyManageUsergroupRemoveConfirmationPage";
			}
		}
	}
}
