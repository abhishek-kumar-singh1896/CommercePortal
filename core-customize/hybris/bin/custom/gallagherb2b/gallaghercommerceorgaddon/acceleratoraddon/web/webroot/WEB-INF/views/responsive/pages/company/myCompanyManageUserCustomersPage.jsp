				        ...
				        <div class="container-lg col-md-6">
							<div class="col-xs-12 col-sm-7">
								<org-common:headline url="${cancelUrl}"
									labelKey="text.myCompany.manageUsers.${action}.title" />
							</div>
												...
												<div class="account-cards card-select">
													<div class="row">
														<c:forEach items="${searchPageData.results}" var="user">
															...
															<div
																id="row-${fn:escapeXml(ycommerce:normalizedCode(user.normalizedUid))}"
																...
																<ul class="pull-left">
																	...
																	<li class="roles-wrapper clearfix"><b><spring:theme
																			...
																			<ul
																				id="roles-${fn:escapeXml(ycommerce:normalizedCode(user.normalizedUid))}">
																...
																<ycommerce:testId code="${action}_actions_label">
																	...
																	<c:choose>
																		<c:when test="${user.active}">
																			<span
																				id="selection-${fn:escapeXml(ycommerce:normalizedCode(user.normalizedUid))}"
