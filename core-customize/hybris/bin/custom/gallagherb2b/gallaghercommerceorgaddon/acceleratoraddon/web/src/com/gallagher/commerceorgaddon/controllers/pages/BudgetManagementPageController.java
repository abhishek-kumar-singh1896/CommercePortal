...
import com.gallagher.commerceorgaddon.forms.B2BBudgetForm;
...
public class BudgetManagementPageController extends MyCompanyPageController
{
	...
	@RequireHardLogIn
	public String manageBudgets(@RequestParam(value = "page", defaultValue = "0")
	...
	final String sortCode, final Model model) throws CMSItemNotFoundException
	{
		...
		return GallaghercommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageBudgetsPage;
	}

	@RequestMapping(value = "/view", method = RequestMethod.GET)
	@RequireHardLogIn
	public String viewBudgetsDetails(@RequestParam("budgetCode")
	final String budgetCode, final Model model) throws CMSItemNotFoundException
	{
		...
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return GallaghercommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageBudgetsViewPage;
	}

	@RequestMapping(value = "/edit", method = RequestMethod.GET)
	@RequireHardLogIn
	public String editBudgetsDetails(@RequestParam("budgetCode")
	final String budgetCode, final Model model) throws CMSItemNotFoundException
	{
		...
		breadcrumbs.add(new Breadcrumb(
				String.format("/my-company/organization-management/manage-budgets/edit?budgetCode=%s", urlEncode(budgetCode)),
				getMessageSource().getMessage("text.company.budget.editPage", new Object[]
				{ budgetCode }, "Edit Budget: {0}", getI18nService().getCurrentLocale()), null));
		model.addAttribute("breadcrumbs", breadcrumbs);
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return GallaghercommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageBudgetsEditPage;
	}

	@RequestMapping(value = "/update", method = RequestMethod.POST)
	@RequireHardLogIn
	public String updateBudgetsDetails(@RequestParam("budgetCode")
	final String budgetCode, @Valid
	final B2BBudgetForm b2BBudgetForm, final BindingResult bindingResult, final Model model,
	...
	public String getAddBudgetPage(final Model model) throws CMSItemNotFoundException
	{
		...
		final List<Breadcrumb> breadcrumbs = myCompanyBreadcrumbBuilder.createManageBudgetsBreadCrumbs();
		breadcrumbs.add(new Breadcrumb("/my-company/organization-management/manage-budgets/update",
				getMessageSource().getMessage("text.company.budget.addPage", null, getI18nService().getCurrentLocale()), null));
		model.addAttribute("breadcrumbs", breadcrumbs);
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return GallaghercommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageBudgetsAddPage;
	}

	@RequestMapping(value = "/add", method = RequestMethod.POST)
	@RequireHardLogIn
	public String addNewBudget(@Valid
	final B2BBudgetForm b2BBudgetForm, final BindingResult bindingResult, final Model model,
			final RedirectAttributes redirectModel) throws CMSItemNotFoundException, ParseException
	{
		b2BBudgetFormValidator.validate(b2BBudgetForm, bindingResult);
	...
	@RequireHardLogIn
	public String enableBudget(@RequestParam("budgetCode")
	final String budgetCode, final Model model) throws CMSItemNotFoundException
	{
	...
	@RequireHardLogIn
	public String confirmDisableBudgets(@RequestParam("budgetCode")
	final String budgetCode, final Model model) throws CMSItemNotFoundException
	{
		final ContentPageModel organizationManagementPage = getContentPageForLabelOrId(ORGANIZATION_MANAGEMENT_CMS_PAGE);
		storeCmsPageInModel(model, organizationManagementPage);
		...
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return GallaghercommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyBudgetDisableConfirm;
	}

	@RequestMapping(value = "/disable", method = RequestMethod.POST)
	@RequireHardLogIn
	public String disableBudget(@RequestParam("budgetCode")
	final String budgetCode, final Model model) throws CMSItemNotFoundException
	{
		try
		{
	...
	@RequireHardLogIn
	public String viewBudgetUnitDetails(@RequestParam("budgetCode")
	final String budgetCode, @RequestParam("unit")
	final String unit, final Model model) throws CMSItemNotFoundException
	{
		...
		myCompanyBreadcrumbBuilder.addViewBudgetBreadCrumbs(breadcrumbs, budgetCode);
		breadcrumbs.add(new Breadcrumb(
				String.format("/my-company/organization-management/manage-budgets/unitDetails?budgetCode=%s&unit=%s",
