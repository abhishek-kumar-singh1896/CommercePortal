...
import com.gallagher.commerceorgaddon.forms.B2BCostCenterForm;
...
public class CostCenterManagementPageController extends MyCompanyPageController
{
	...
	@RequireHardLogIn
	public String viewCostCenterUnitDetails(@RequestParam("costCenterCode")
	final String costCenterCode, @RequestParam("unit")
	final String unit, final Model model) throws CMSItemNotFoundException
	{
		...
		breadcrumbs.add(new Breadcrumb(
				String.format("/organization-management/manage-costcenters/unitDetails/?costCenterCode=%s&unit=%s",
						urlEncode(costCenterCode), urlEncode(unit)),
				getMessageSource().getMessage("text.company.manage.units.details", new Object[]
	...
	@RequireHardLogIn
	public String manageCostCenters(@RequestParam(value = "page", defaultValue = "0")
	final int page, @RequestParam(value = "show", defaultValue = "Page")
	final AbstractSearchPageController.ShowMode showMode, @RequestParam(value = "sort", defaultValue = B2BCostCenterModel.CODE)
	final String sortCode, final Model model) throws CMSItemNotFoundException
	{
		...
		model.addAttribute("breadcrumbs", breadcrumbs);
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return GallaghercommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageCostCentersPage;
	}

	@Override
	@RequestMapping(value = "/view", method = RequestMethod.GET)
	@RequireHardLogIn
	public String viewCostCenterDetails(@RequestParam("costCenterCode")
	final String costCenterCode, final Model model) throws CMSItemNotFoundException
	{
	...
	@RequireHardLogIn
	public String assignBudgetsForCostCenter(@RequestParam(value = "page", defaultValue = "0")
	final int page, @RequestParam(value = "show", defaultValue = "Page")
	final AbstractSearchPageController.ShowMode showMode, @RequestParam(value = "sort", defaultValue = B2BBudgetModel.CODE)
	final String sortCode, @RequestParam("costCenterCode")
	final String costCenterCode, final Model model, final HttpServletRequest request) throws CMSItemNotFoundException
	{
		final PageableData pageableData = createPageableData(page, getSearchPageSize(), sortCode, showMode);
		...
		breadcrumbs.add(new Breadcrumb(String.format(MANAGE_COSTCENTERS_SELECTBUDGET_URL, costCenterCode),
				getMessageSource().getMessage("text.company.costCenter.select.budget", null, "Edit Related Budgets",
						getI18nService().getCurrentLocale()),
				null));
		model.addAttribute("breadcrumbs", breadcrumbs);
		model.addAttribute("cancelUrl", getCancelUrl(MANAGE_COSTCENTERS_VIEW_URL, request.getContextPath(), costCenterCode));
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return GallaghercommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanySelectBudgetPage;
	}
	...
	{ RequestMethod.POST })
	@RequireHardLogIn
	public B2BSelectionData selectBudgetForCostCenter(@RequestParam("costCenterCode")
	final String costCenterCode, @RequestParam("budgetCode")
	final String budgetCode) throws CMSItemNotFoundException
	{
	...
	{ RequestMethod.POST })
	@RequireHardLogIn
	public B2BSelectionData deselectBudgetForCostCenter(@RequestParam("costCenterCode")
	final String costCenterCode, @RequestParam("budgetCode")
	final String budgetCode) throws CMSItemNotFoundException
	{
		try
	...
	@RequireHardLogIn
	public String enableCostCenter(@RequestParam("costCenterCode")
	final String costCenterCode, final Model model) throws CMSItemNotFoundException
	{
		try
		{
	...
	@RequireHardLogIn
	public String confirmDisableCostCenter(@RequestParam("costCenterCode")
	final String costCenterCode, final Model model) throws CMSItemNotFoundException
	{
		final ContentPageModel organizationManagementPage = getContentPageForLabelOrId(ORGANIZATION_MANAGEMENT_CMS_PAGE);
		storeCmsPageInModel(model, organizationManagementPage);
		...
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return GallaghercommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyCostCenterDisableConfirm;
	}

	@RequestMapping(value = "/disable", method = RequestMethod.POST)
	@RequireHardLogIn
	public String disableCostCenter(@RequestParam("costCenterCode")
	final String costCenterCode, final Model model) throws CMSItemNotFoundException
	{
		try
		{
	...
	@RequireHardLogIn
	public String editCostCenterDetails(@RequestParam("costCenterCode")
	final String costCenterCode, final Model model) throws CMSItemNotFoundException
	{
		model.addAttribute("actionUrl", "update");
		model.addAttribute("edit", Boolean.TRUE);
		model.addAttribute("title", getMessageSource().getMessage("text.company.costCenter.edit.title", null, "Edit Cost Center",
				getI18nService().getCurrentLocale()));
	...
	@RequireHardLogIn
	public String updateCostCenterDetails(@Valid
	final B2BCostCenterForm b2BCostCenterForm, final BindingResult bindingResult, final Model model,
	...
	public String addCostCenter(final Model model) throws CMSItemNotFoundException
	{
		...
		model.addAttribute("title", getMessageSource().getMessage("text.company.costCenter.create.label", null,
				"Create Cost Center", getI18nService().getCurrentLocale()));
	...
	@RequireHardLogIn
	public String saveCostCenter(@Valid
	final B2BCostCenterForm b2BCostCenterForm, final BindingResult bindingResult, final Model model,
			final RedirectAttributes redirectModel) throws CMSItemNotFoundException
	{
		model.addAttribute("actionUrl", "add");
