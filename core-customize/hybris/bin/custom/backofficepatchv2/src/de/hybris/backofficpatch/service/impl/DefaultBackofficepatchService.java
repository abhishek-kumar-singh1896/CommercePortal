...
public class DefaultBackofficepatchService implements BackofficepatchService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultBackofficepatchService.class);
	...
	{
		return DefaultBackofficepatchService.class.getResourceAsStream("/backofficepatch/sap-hybris-platform.png");
	}
