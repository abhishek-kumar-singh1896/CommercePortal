...
public class DefaultBraintreeRefundService extends DefaultRefundService implements BraintreeRefundService
{
			...
			final PaymentTransactionModel transaction)
	{
		...
		LOG.info("processBrainTreeRefund, orderId: " + orderId + ", transaction:" + transaction + ", transaction.reqId:" + transaction.getRequestId() + ", refundAmount: " + refundAmount);
		...
		final BrainTreeRefundTransactionResult brainTreeRefundTransactionResult = getBrainTreePaymentService().refundTransaction(request);
