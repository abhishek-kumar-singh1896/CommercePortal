...
public class BrainTreeCreatePaymentMethodResult extends BrainTreeAbstractResult
{
    ...
    public String toString() {
        return "BrainTreeCreatePaymentMethodResult [paymentMethodToken=" + paymentMethodToken + ", imageSource=" + imageSource + ", cardType=" + cardType + ", cardNumber="
                + cardNumber + ", cardholderName=" + cardholderName + ", expirationMonth=" + expirationMonth + ", expirationYear=" + expirationYear + ", email=" + email + "]";
    }
