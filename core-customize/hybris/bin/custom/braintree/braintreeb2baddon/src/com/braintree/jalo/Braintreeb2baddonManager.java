...
/**
 * This is the extension manager of the Braintreeb2baddon extension.
 */
public class Braintreeb2baddonManager extends GeneratedBraintreeb2baddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Braintreeb2baddonManager.class.getName());
	 ...
	 */
	public static Braintreeb2baddonManager getInstance()
	{
		return (Braintreeb2baddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Braintreeb2baddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Braintreeb2baddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Braintreeb2baddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Braintreeb2baddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Braintreeb2baddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
