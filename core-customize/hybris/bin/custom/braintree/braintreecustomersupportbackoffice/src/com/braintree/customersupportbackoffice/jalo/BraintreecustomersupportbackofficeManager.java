 ...
 */
package com.braintree.customersupportbackoffice.jalo;
 ...
 */
public class BraintreecustomersupportbackofficeManager extends GeneratedBraintreecustomersupportbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(BraintreecustomersupportbackofficeManager.class.getName());
	 ...
	 */
	public static BraintreecustomersupportbackofficeManager getInstance()
	{
		return (BraintreecustomersupportbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(BraintreecustomersupportbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public BraintreecustomersupportbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of BraintreecustomersupportbackofficeManager called.");
		}
	}
