...
/**
 * This is the extension manager of the Braintreefacades extension.
 */
public class BraintreefacadesManager extends GeneratedBraintreefacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(BraintreefacadesManager.class.getName());
	 ...
	 */
	public static BraintreefacadesManager getInstance()
	{
		return (BraintreefacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				BraintreefacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public BraintreefacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of BraintreefacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of BraintreefacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of BraintreefacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
