...
import org.training.constants.PlaypenbackofficeConstants;
 ...
 */
public class PlaypenbackofficeManager extends GeneratedPlaypenbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(PlaypenbackofficeManager.class.getName());
	 ...
	 */
	public static PlaypenbackofficeManager getInstance()
	{
		return (PlaypenbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(PlaypenbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PlaypenbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of PlaypenbackofficeManager called.");
		}
	}
