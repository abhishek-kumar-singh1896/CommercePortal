...
public class SaleTransactionCommandImpl extends AbstractCommand implements BrainTreeSaleCommand
{
	...
	private void addSubmitForSettlement(TransactionOptionsRequest options, BrainTreeAuthorizationRequest brainTreeAuthorizationRequest)
	{
	...
	private void addInVaultProperty(final BrainTreeSaleTransactionRequest request, final TransactionOptionsRequest options)
	{
		...
		else if (BraintreeConstants.ON_SUCCESS.equalsIgnoreCase(getBrainTreeConfigService().getStoreInVault()))
		{
