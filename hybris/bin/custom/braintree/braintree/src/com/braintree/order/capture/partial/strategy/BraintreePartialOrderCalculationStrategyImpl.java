...
public class BraintreePartialOrderCalculationStrategyImpl implements BraintreePartialOrderCalculationStrategy
{
	...
	protected BigDecimal calculateTransaction(PaymentTransactionModel paymentTransactionModel, Double totalPrice)
	{
		...
		return BigDecimal.valueOf(totalPrice).subtract(amount);
	}
}
