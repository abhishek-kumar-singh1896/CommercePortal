...
import com.braintree.constants.Braintreeb2bfacadesConstants;



/**
 * This is the extension manager of the Braintreeb2bfacades extension.
 */
public class Braintreeb2bfacadesManager extends GeneratedBraintreeb2bfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Braintreeb2bfacadesManager.class.getName());
	 ...
	 */
	public static Braintreeb2bfacadesManager getInstance()
	{
		return (Braintreeb2bfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Braintreeb2bfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Braintreeb2bfacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Braintreeb2bfacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Braintreeb2bfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Braintreeb2bfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
