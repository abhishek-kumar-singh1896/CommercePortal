...
public class DefaultB2badvanceoutboundintegrationService implements B2badvanceoutboundintegrationService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultB2badvanceoutboundintegrationService.class);
	...
	{
		return DefaultB2badvanceoutboundintegrationService.class.getResourceAsStream("/b2badvanceoutboundintegration/sap-hybris-platform.png");
	}
