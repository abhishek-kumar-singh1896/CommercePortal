 ...
 */
package com.enterprisewide.b2badvance.cockpits.setup;
...
import com.enterprisewide.b2badvance.cockpits.constants.B2badvanceCockpitsConstants;
 ...
 */
@SystemSetup(extension = B2badvanceCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(B2badvanceCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(B2badvanceCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						B2badvanceCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/b2badvancecockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
