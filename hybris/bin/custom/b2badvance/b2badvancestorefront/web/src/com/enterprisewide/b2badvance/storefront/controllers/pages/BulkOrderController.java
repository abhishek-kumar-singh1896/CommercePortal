...
public class BulkOrderController
{
	...
	public @ResponseBody
    List<ProductData> search(@RequestParam("query") final String query,
                             @RequestParam("resultSize") final Integer resultSize, final HttpServletRequest request, final Model model)
	{
	...
	public void select(@RequestParam("qty") final Integer qty, @RequestParam("order") final Integer order,
                       @RequestParam("code") final String code, final HttpServletRequest request, final Model model)
	{
	...
	@ResponseStatus(value = HttpStatus.OK)
	public void select(@RequestParam("order") final Integer order, final HttpServletRequest request, final Model model)
	{
