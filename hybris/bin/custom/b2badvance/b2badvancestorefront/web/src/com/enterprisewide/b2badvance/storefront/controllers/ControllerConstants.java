 ...
 */
package com.enterprisewide.b2badvance.storefront.controllers;
...
public interface ControllerConstants
{
    ...
    interface Actions
    {
        interface Cms // NOSONAR
        {
            ...
            String AccountBillingHistoryPage = "pages/account/accountBillingHistoryPage";// NOSONAR
        }
    }
    ...
    interface Views
    {
        ...
        interface Pages
        {
            ...
            interface Order
            {
                String BulkOrderForm = "pages/order/bulkOrderFormPage";
            }
        }
        ...
        interface Fragments
        {
            ...
            interface Product // NOSONAR
            {
                ...
                String CompareDiv = "fragments/product/compareProducts";
            }
            interface QuickOrder // NOSONAR
            {
