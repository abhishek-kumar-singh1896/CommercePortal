...
<div class="hidden">
	...
	<div id="popup_confirm_ordertemplate_delete_${fn:escapeXml(savedCart.code)}"
		class="js-ordertemplate_delete_confirm_modal"
		data-savedCartInfo="${fn:escapeXml(savedCartInfo)}">
		<p>
			<spring:theme code="text.account.ordertemplate.delete.msg"/>
		</p>
		...
		<div class="modal-actions">
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-sm-push-6">
					<button type="button" class="js-ordertemplate_delete_confirm btn btn-primary btn-block"
						data-savedcart-id="${fn:escapeXml(savedCart.code)}"><spring:theme code="general.delete.button"/>
					</button>
				</div>
				<div class="col-xs-12 col-sm-6 col-sm-pull-6">
					<button type="button" class="js-ordertemplate_delete_confirm_cancel btn btn-default btn-block">
