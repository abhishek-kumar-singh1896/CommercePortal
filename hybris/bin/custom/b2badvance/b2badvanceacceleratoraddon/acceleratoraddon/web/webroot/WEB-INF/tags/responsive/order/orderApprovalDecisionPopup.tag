...
<%@ attribute name="orderApprovalDecisionForm" required="true" type="com.enterprisewide.b2badvanceacceleratoraddon.forms.OrderApprovalDecisionForm"%>
                    ...
                    <div class="${modalPopupClass} comment-modal">
                        ...
                        <div class="form-actions clearfix" style="clear: both;">
                            ...
                            <div class="form-actions clearfix row" style="clear:both;">
                                ...
                                <div class="col-sm-6">
                                    <button type="button" class="btn btn-primary btn-block approverDecisionButton col-md-4 pull-right" data-decision="${decision}">
                                        <spring:theme code="${actionButtonLabel}" />
                                    </button>
                                </div>
                            </div>
