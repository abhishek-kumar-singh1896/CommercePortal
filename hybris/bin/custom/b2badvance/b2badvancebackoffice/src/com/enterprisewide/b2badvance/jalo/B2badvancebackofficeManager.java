 ...
 */
package com.enterprisewide.b2badvance.jalo;
...
import com.enterprisewide.b2badvance.constants.B2badvancebackofficeConstants;
 ...
 */
public class B2badvancebackofficeManager extends GeneratedB2badvancebackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(B2badvancebackofficeManager.class.getName());
	 ...
	 */
	public static B2badvancebackofficeManager getInstance()
	{
		return (B2badvancebackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(B2badvancebackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public B2badvancebackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of B2badvancebackofficeManager called.");
		}
	}
