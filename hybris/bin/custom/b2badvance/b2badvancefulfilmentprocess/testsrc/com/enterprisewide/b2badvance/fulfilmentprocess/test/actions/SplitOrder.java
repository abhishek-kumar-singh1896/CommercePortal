 ...
 */
package com.enterprisewide.b2badvance.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(B2badvanceFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(B2badvanceFulfilmentProcessConstants.PARENT_PROCESS);
